...
|----------|-------|-------|
| Implemented apps | 2 | `apps/driver_app`, `apps/admin_app` |
| Planned apps with no code folder | 3 | `rider_app`, `trip_media_web`, `trip_website` |
...
| `trip_media_web` | Missing | `docs/planning/trip_media_web` | `planning` | Docs complete; partner portal app, partner billing migrations, and payment webhooks are missing. |
| `trip_website` | Missing | `docs/planning/trip_website` | `planning` | Docs complete; marketing app scaffold and optional lead capture are missing. |
...
- `apps/trip_media_web` does not exist yet, despite complete planning docs and prompt chain.
- `apps/trip_website` does not exist yet, despite complete planning docs and prompt chain.
