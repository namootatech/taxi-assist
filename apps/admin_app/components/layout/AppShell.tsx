            ...
            <div className="flex items-center justify-between gap-2 p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <div className="truncate text-sm font-semibold tracking-tight">Operations Console</div>
                ...
                <div key={g.label}>
                  ...
                  <div className="flex flex-col gap-1">
                    {g.items.map((it) => {
                      ...
                      return (
                        <div key={it.href} onClick={() => setMobileNavOpen(false)}>
                          <NavLink
                            href={it.href}
                            label={it.label}
                            active={active}
        ...
        <header className="sticky top-0 z-10 flex items-center justify-between gap-3 border-b border-token surface-1 px-4 py-3 md:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs muted">Live operations • Actions are logged</div>
            </div>
          </div>
