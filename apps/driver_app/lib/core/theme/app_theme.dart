...
abstract final class AppTheme {
  static TextTheme buildTextTheme({required Brightness brightness}) {
    ...
    return base.copyWith(
      displayLarge: s(base.displayLarge, weight: FontWeight.w900, letterSpacing: -0.6, height: 1.02),
      displayMedium: s(base.displayMedium, weight: FontWeight.w900, letterSpacing: -0.5, height: 1.04),
      displaySmall: s(base.displaySmall, weight: FontWeight.w900, letterSpacing: -0.4, height: 1.06),
      headlineLarge: s(base.headlineLarge, weight: FontWeight.w800, letterSpacing: -0.35, height: 1.10),
      headlineMedium: s(base.headlineMedium, weight: FontWeight.w800, letterSpacing: -0.25, height: 1.12),
      headlineSmall: s(base.headlineSmall, weight: FontWeight.w800, letterSpacing: -0.15, height: 1.14),
  ...
  static ThemeData get light {
    ...
    const marketingBackground = Color(0xFFFFFAF4);
  ...
  static ThemeData get dark {
    const brandRed = Color(0xFFFE0000);
    const brandNavy = Color(0xFF244065);
    const portalBackground = Color(0xFF07111F);
    const portalSurface = Color(0xFF0D1A2D);
    final scheme = ColorScheme.fromSeed(
      seedColor: brandNavy,
